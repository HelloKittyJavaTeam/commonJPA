...
import it.hellokitty.gt.repository.impl.DealerRolesRepositoryImpl;
import it.hellokitty.gt.repository.utils.ColumnDirection;
import it.hellokitty.gt.service.DealerRolesService;
...
public class DealerRolesServiceImpl  implements DealerRolesService {
	...
	@Override
	public DealerRoles fetchById(Long id) throws IllegalArgumentException, Exception {
		if(id == null){
	...
	@Override
	public List<DealerRoles> fetchAll(Integer start, Integer limit, List<ColumnDirection> cdList) throws Exception {
		if(start == null){
		...
		return dealerRolesRepository.fetchAll(start, limit, cdList);
	}

	@Override
	public List<DealerRoles> fetchAll(String user, Integer start, Integer limit, List<ColumnDirection> cdList) throws IllegalArgumentException, Exception {
		if(user == null){
		...
		return dealerRolesRepository.fetchAll(user, start, limit, cdList);
	}
	...
	public Long count(String user) throws IllegalArgumentException, Exception {
		...
		return dealerRolesRepository.count(user);
	}
}