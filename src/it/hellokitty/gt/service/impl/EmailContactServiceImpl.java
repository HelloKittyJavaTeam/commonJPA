...
public class EmailContactServiceImpl implements EmailContactService {
	...
	@Override
	public EmailContact fetchById(Long id) throws IllegalArgumentException, Exception {
		if(id == null){
	...
	@Override
	public List<EmailContact> fetchAll(Integer start, Integer limit, List<ColumnDirection> cdList) throws Exception {
		if(start == null){
		...
		return emailContactRepository.fetchAll(start, limit, cdList);
	}

	@Override
	public List<EmailContact> fetchAll(String user, Integer start, Integer limit, List<ColumnDirection> cdList) throws IllegalArgumentException, Exception {
		if(user == null){
		...
		return emailContactRepository.fetchAll(user, start, limit, cdList);
	}

	@Override
	public void insert(EmailContact elem, String user) throws IllegalArgumentException, Exception {
		if(elem == null){
	...
	@Override
	public void delete(EmailContact elem, String user) throws IllegalArgumentException, Exception {
		if(elem == null){
			throw new IllegalArgumentException(this.getClass().getPackage()+" - "+this.getClass()+" - elem parameter can't be null.");
		}
	...
	@Override
	public EmailContact update(EmailContact elem, String user) throws IllegalArgumentException, Exception {
		if(elem == null){
			throw new IllegalArgumentException(this.getClass().getPackage()+" - "+this.getClass()+" - elem parameter can't be null.");
		}
		...
		return emailContactRepository.update(elem, user);
	}

	@Override
	public EmailContact merge(EmailContact elem, String user) throws IllegalArgumentException, Exception {
		if(elem == null){
			throw new IllegalArgumentException(this.getClass().getPackage()+" - "+this.getClass()+" - elem parameter can't be null.");
		}
	...
	public Long count(String user) throws IllegalArgumentException, Exception {
		...
		return emailContactRepository.count(user);
	}

	@Override
	public List<EmailContact> fetchByName(String name, String user, Integer start, Integer limit, List<ColumnDirection> cdList) throws IllegalArgumentException, Exception {
		if(name == null){
			throw new IllegalArgumentException(this.getClass().getPackage()+" - "+this.getClass()+" - name parameter can't be null.");
		}
		
		if(name.equals("")){
			throw new IllegalArgumentException(this.getClass().getPackage()+" - "+this.getClass()+" - name parameter can't be empty.");
		}
		...
		return emailContactRepository.fetchByName(name, user, start, limit, cdList);
	}

	@Override
	public List<EmailContact> search(String content, String user, Integer start, Integer limit, List<ColumnDirection> cdList) throws IllegalArgumentException, Exception {
		if(content == null){
		...
		return emailContactRepository.search(content, user, start, limit, cdList);
	}
